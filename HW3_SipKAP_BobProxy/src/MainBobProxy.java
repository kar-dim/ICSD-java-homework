...
public class MainBobProxy {

    public static void main(String[] args) {
        try (ServerSocket server = new ServerSocket(2312)) {
            ...
            while (true) {
                ...
                if (choice.equals("StartSTS")) {
                    new Thread(new BobProxy(connection, outputstream, inputstream, "RSA")).start();
            ...
            Logger.getLogger(MainBobProxy.class.getName()).log(Level.SEVERE, null, ex);
